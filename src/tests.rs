...
fn test_graph(node_num: usize, entry: usize, edges: Vec<(usize, usize)>) {
...
fn random_test() {
    random_test_seeded(
        [
            236, 223, 150, 56, 234, 1, 79, 246, 129, 242, 218, 136, 172, 41, 155, 16, 148, 176, 84,
            123, 242, 3, 243, 252, 111, 163, 226, 142, 185, 151, 82, 129,
        ],
        6,
        0.4,
    );
